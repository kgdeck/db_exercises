...
\usepackage{enumitem}      % this and the following two lines are responsible for left-assigned dots etc.  kgd
...
\newcommand{\passthrough}[1]{#1} % required by Quarto

\lstdefinelanguage{SQL}{
  morekeywords=[1]{SELECT,FROM,WHERE,HAVING,INSERT,INTO,VALUES,UPDATE,SET,DELETE,CREATE,DROP,ALTER,JOIN,GRANT,ASC,DESC,AS,AVG,SUM,MAX,MIN,PRIVILEGE,GROUP,ROWS,COUNT,BY,LEFT,RIGHT,INNER,JOIN,OUTER,FULL,FETCH,ORDER,ONLY,FIRST,SCHEMA,TABLE,IS,NULL,NOT,BETWEEN,AND,OR,CASE,WHEN,THEN,ELSE,IF,END,DATE,INT,INTEGER,DOUBLE,VARCHAR,NUMERIC,DECIMAL,PRIMARY,KEY,FOREIGN,REFERENCES,CASCADE,CONSTRAINT,CHECK,ON,INDEX,DISTINCT,EXISTS,UNION,ALL,MINUS,EXCEPT,INTERSECT},
  sensitive=false,
  morecomment=[l]{--},
  morestring=[b]'
}
...
% Tabellen linksbündig statt zentriert, nächste 4 Zeilen hinzugefügt (kgd)
\usepackage{etoolbox}
